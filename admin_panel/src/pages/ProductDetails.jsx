  ...
  useEffect(() => {
    ...
    const fetchReviews = async () => {
      try {
        ...
        const endpoint =
          userRole === "адміністратор" ? "reviews-admin" : "reviews-user";
              ...
              {data.discount > 0 ? (
                <>
                  ...
                  <span className="font-bold">
                    {calculateDiscountedPrice().toFixed(2)} грн
                  </span>
          ...
          {data.sizes.length > 0 ? (
            <div className="space-y-2">
              {data.sizes.map((size, index) => (
                <div
                  key={index}
                  className="flex justify-between bg-gray-100 p-3 rounded-md text-gray-700"
                >
            ...
            <div className="mt-4 space-y-4">
              {reviews.length > 0 ? (
                reviews.map((review) => (
                  <div
                    ...
                    className={`p-4 rounded-lg ${
                      review.isVisible ? "bg-white" : "bg-gray-100"
                    }`}
                  >
                ...
                <p className="text-gray-500 text-center py-4">
                  Немає відгуків для цього товару
                </p>
              )}
            </div>
          )}

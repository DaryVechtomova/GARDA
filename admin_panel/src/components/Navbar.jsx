                            ...
                            <>
                                ...
                                {userData && (
                                    <span className="hidden md:inline text-sm font-medium text-gray-700">
                                        {userData.firstName || userData.email} {/* Показуємо ім'я або email */}
                                    </span>
                                )}
                            </>
                        )}
                    ...
                    {isDropdownOpen && (
                        ...
                        >
                            ...
                            <NavLink
                                ...
                                className={({ isActive }) => // Стилізація активного посилання
                                    `flex items-center gap-3 px-4 py-2 text-sm ${isActive ? 'bg-gray-100 text-gray-900' : 'text-gray-700'} hover:bg-gray-100 w-full text-left`
                                }
                                role="menuitem"
                            >

...
const Categories = () => {
  ...
  const flowerStyles = calculateStyles(
    600,
    1540,
    mobileStyles.flower,
    desktopStyles.flower
  );
  const sectionTop = interpolate(
    windowWidth,
    600,
    mobileStyles.section.top,
    1540,
    desktopStyles.section.top
  );
  ...
  return (
    <section
      id="categories"
      className="max-padd-container pt-40 relative"
      style={{
        top: `${sectionTop}px`,
      }}
    >
      ...
      <div className="flex flex-col items-center relative">
        ...
        <div
          className="flex justify-center gap-12 flex-wrap w-full"
            ...
            return (
              ...
              >
                ...
                <div className="overflow-hidden rounded-lg">
                  {" "}
                  {/* Додано для кращого ховер ефекту */}
                  <img
                    src={item.image}
                ...
                <h4 className="mt-6 regular-18 group-hover:text-secondary transition-colors duration-200">
                  {" "}
                  {/* Простий ховер ефект */}
                  {item.name}
                </h4>

...
const Header = ({ setShowLogin }) => {
  ...
  return (
    <header
      ...
      } fixed w-full top-0 left-0 right-0 py-4 z-30 transition-all bg-[#fcfaf4]`}
    >
      <div className="max-padd-container">
        <div className="flexBetween">
          ...
          <div className="flex-1 flexCenter">
            <Link to={"/"}>
              <h1
                className="text-[24px] sm:text-[30px] font-bold text-center"
          ...
          >
            ...
            >
              <div className="p-5">
                <HiX
                  onClick={toggleMenu}
                  className="cursor-pointer hover:text-secondary text-2xl mb-5"
                />
